...
let stateNail = [
	"https://i.ibb.co/CnWJj0J/Nail-State01.png",
	"https://i.ibb.co/rd81Gx8/Nail-State02.png",
	"https://i.ibb.co/rd6Wd5t/Nail-State03.png"
];
...
function reset() {
	...
	document.querySelector(".nail7").src = "https://i.ibb.co/CnWJj0J/Nail-State01.png";
	document.querySelector(".nail7").id = "stateNail1";
	document.querySelector(".nail7").style.display = 'none';

	document.querySelector(".nail8").src = "https://i.ibb.co/CnWJj0J/Nail-State01.png";
...
$("#close").click(function () {
    $.post('http://crp_horseshoe/exit', JSON.stringify({}));
    return
});
...
function setStateNail(element) {
	switch (element.id) {
  	case "stateNail1":
    	...
    	element.src = "https://i.ibb.co/2jCp0pV/Nail-State02.png";
    	break;
 	case "stateNail2":
    	element.id = "stateNail3";
    	element.src = "https://i.ibb.co/rd6Wd5t/Nail-State03.png";
        nailed = nailed + 1;
        ...
        if (nailed === 8) {
			...
			$.post('http://crp_wheel/HorseShoeWasFixed', JSON.stringify({ status: "FIXED" }));
			finish();
        }
    break;
	}
